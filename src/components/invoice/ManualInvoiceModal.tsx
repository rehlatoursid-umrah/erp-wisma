...
const PREDEFINED_ITEMS: Record<string, { name: string, price: number }[]> = {
    'auditorium': [
        { name: 'Auditorium Paket 4 Jam', price: 540 },
        { name: 'Auditorium Paket 9 Jam', price: 1180 },
        ...
        { name: 'AC 10 Jam s.d. 12 Jam', price: 340 },
        { name: 'AC 13 Jam s.d. 14 Jam', price: 390 },
        ...
        { name: '2 Set Sofa Lesehan', price: 200 },
