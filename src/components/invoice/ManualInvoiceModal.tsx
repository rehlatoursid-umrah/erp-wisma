...
const PREDEFINED_ITEMS: Record<string, { name: string, price: number }[]> = {
    'auditorium': [
        { name: 'Auditorium Paket 4 Jam', price: 420 },
        { name: 'Auditorium Paket 9 Jam', price: 900 },
        { name: 'Auditorium Paket 12 Jam', price: 1100 },
        { name: 'Auditorium Paket 14 Jam', price: 1250 },
        { name: 'Auditorium Per 1 Jam', price: 115 },
        { name: 'Extra Charge Diluar Jam Operasional', price: 125 },
        { name: 'Ruang VIP', price: 500 },
        { name: 'AC 4 Jam s.d. 6 Jam', price: 150 },
        { name: 'AC 7 Jam s.d. 9 Jam', price: 200 },
        { name: 'AC 10 Jam s.d. 12 Jam', price: 300 },
        { name: 'AC 13 Jam s.d. 14 Jam', price: 350 },
        { name: 'Meja 3 Pcs', price: 140 },
        { name: 'Meja 6 Pcs', price: 240 },
        { name: 'Meja 9 Pcs', price: 300 },
        { name: 'Kursi 3 Pcs', price: 75 },
        { name: 'Kursi 5 Pcs', price: 120 },
        { name: 'Kursi 7 Pcs', price: 160 },
        { name: 'Kursi 10 Pcs', price: 210 },
        { name: 'Kursi 15 Pcs', price: 300 },
        { name: 'Kursi 20 Pcs', price: 380 },
        { name: 'Kursi 30 Pcs', price: 540 },
        { name: 'Kursi 40 Pcs', price: 680 },
        { name: 'Projector Only', price: 250 },
        { name: 'Screen Only', price: 75 },
        { name: 'Projector dan Screen', price: 275 },
        { name: 'Sewa Dapur', price: 220 },
        { name: 'Sudut Serba guna', price: 800 },
        { name: '1 Set Sofa Lesehan', price: 150 },
        { name: '2 Set Sofa Lesehan', price: 150 },
        { name: 'Piring 6 Pcs', price: 60 },
        { name: 'Piring 12 Pcs', price: 110 },
        { name: 'Piring 18 Pcs', price: 160 },
        { name: 'Piring 24 Pcs', price: 200 },
        { name: 'Gelas 6 Pcs', price: 30 },
        { name: 'Gelas 12 Pcs', price: 55 },
        { name: 'Gelas 18 Pcs', price: 80 },
        { name: 'Gelas 24 Pcs', price: 100 },
        { name: 'Gelas 30 Pcs', price: 125 },
        { name: 'Gelas 36 Pcs', price: 135 }
    ],
    'hotel': [
        { name: 'Late check-out Single Bed (8:00 PM to 12:00 PM)', price: 30 },
        { name: 'Late check-out Double Bed (8:00 PM to 12:00 PM)', price: 35 },
        { name: 'Late check-out All rom(1:00 PM to 4:00 PM)', price: 5 },
        { name: 'Reservation Letter', price: 10 },
        { name: 'Room 101 (Double Bed Room)', price: 35 },
        { name: 'Room 102 (Single Bed Room)', price: 30 },
        { name: 'Room 103 (Single Bed Room)', price: 30 },
        { name: 'Room 104 (Double Bed Room)', price: 35 },
        { name: 'Room 105 (Double Bed Room)', price: 35 },
        { name: 'Room 106 (Double Bed Room)', price: 35 },
        { name: 'Room 201 (Double Bed Room)', price: 35 },
        { name: 'Room 202 (Single Bed Room)', price: 30 },
        { name: 'Room 203 (Single Bed Room)', price: 30 },
        { name: 'Room 204 (Tripple Bed Room)', price: 30 },
        { name: 'Room 205 (Quadrupple Bed Room)', price: 35 },
        { name: 'Room 206 (Quadrupple Bed Room)', price: 35 },
        { name: 'Airport Transfer 2-4 seater', price: 35 },
        { name: 'Airport Transfer 4-8 seater', price: 50 },
        { name: 'Early check-in (6:00 AM to 8:00 AM)', price: 15 },
        { name: 'Early check-in (8:00 AM to 12:00 PM)', price: 5 },
