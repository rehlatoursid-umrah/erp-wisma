...
export const ROOM_TYPES = {
    ...
    double: { label: 'Double Bed', price: 35, maxQty: 5, allowExtraBed: true, icon: '🛏️🛏️' },
    triple: { label: 'Triple Bed', price: 30, maxQty: 1, allowExtraBed: true, icon: '🛏️×3' },
    quadruple: { label: 'Quadruple', price: 35, maxQty: 2, allowExtraBed: true, icon: '🛏️×4' },
