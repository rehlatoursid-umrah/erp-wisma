            ...
            <div className="success-container">
                ...
                <div className="success-header">
                    ...
                    <p className="success-message">
                        Your hotel reservation has been submitted and is pending confirmation.
                    </p>
                </div>
                        ...
                        <div className="receipt-body">
                            <div className="detail-row">
                                ...
                                <div className="content">
                                    ...
                                    <span className="value">Hotel Room</span>
                                </div>
                            </div>
                        ...
                        <div className="receipt-footer">
                            ...
                            <div className="total-row">
                                ...
                                <div className="price-display">
                                    ...
                                    <span className="amount">{totalUSD}</span>
                                    {totalEGP !== '0' && (
                                        <span style={{ fontSize: '1rem', color: '#a1a1aa', marginLeft: '8px' }}>+ {totalEGP} EGP</span>
                                    )}
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="side-cards">
                        ...
                        <div className="bento-card steps-card">
                            ...
                            <ul className="step-list">
                                ...
                                <li>Enjoy your stay at Wisma Nusantara!</li>
                            </ul>
                        </div>
                    </div>
                </div>
                ...
                <div className="action-buttons">
                    <Link href="/booking/hotel" className="premium-btn ghost">
                        ← New Booking
                    </Link>
                    <a href="https://wa.me/6285189916769" target="_blank" rel="noreferrer" className="premium-btn whatsapp">
...
export default function HotelSuccessPage() {
    return (
        <Suspense fallback={<div style={{ minHeight: '100vh', background: '#0f0f11', display: 'flex', alignItems: 'center', justifyContent: 'center', color: '#fff' }}>Loading...</div>}>
            <HotelSuccessContent />
        </Suspense>
    )
}
